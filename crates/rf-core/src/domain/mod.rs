...
pub use artifact::{
    ...
    PullRequestSummary, ReviewDecisionSummary, ScanArtifact, SourceCoverageArtifact,
    SourceCoverageEntry, SourceCoverageName, SourceCoverageStatus, SourceFailureReason,
    derive_data_coverage_from_sources,
};
